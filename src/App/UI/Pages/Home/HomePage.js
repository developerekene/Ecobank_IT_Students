    ...
    return(
        ...
        <div className="body">
            <div className="body-text">
                ...
                <p>Start, switch, or advance your career with more than 500 courses, Professional Certificates, and degrees from world-class universities and companies.</p>
            ...
            <div id="colab-div">
                <div className="colab-text">
                    <h4>We collaborate with <span><a href="#">50+ universities and companies</a></span> to provide you with the best learning experience</h4>
                </div>
